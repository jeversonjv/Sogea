    ...
    <body>
        ...
        <div class="container" style="margin-top: 5%;">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                Clique em um evento para analisar suas presenças.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                Pode levar de 10-20 segundos para gerar, tenha paciência!
            </div>
            <table  id="tabela" class="table table-bordered table-striped">
                ...
                <tbody>
                    {eventos}
                    <tr>
                        <td ><a href="{url}Inicio/presenca/participante/gerar/{id_evento}/{id_participante}" target="__blanck">{nome}</a></td>
                    </tr>
                    {/eventos}
                </tbody>
            </table>
